...
const backgrounds: IBackground[] = [
  {
    ...
    features: [
      {
        name: 'Inheritance',
        description: `<p>You have advantage on any rolls you make when consorting with nobles, negotiating prices, or leveraging your reputation to get what you want. Take an extra handful of gold at character creation.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Well-Read',
        description: `<p>You have advantage on any rolls you make that deal with the history, culture, or politics of a prominent person or place.</p>`,
      },
    ],
  },
  {
    ...
    characteristics: `Orderborne are often: ambitious, benevolent, pensive, prudent, sardonic, stoic.`,
    features: [
      {
        name: 'Dedicated',
        description: `<p>Record three sayings or values your upbringing instilled in you. Once per short rest, when you describe how you’re embodying one of these principles through your current action, you may roll with a d20 as your Hope Die instead of a d12.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Steady',
        description: `<p>You have advantage on traversing dangerous cliffs and ledges, navigating harsh environments, and survival knowledge. Also gain +1 to your Armor Score.</p>`,
      },
    ],
  },
  {
    ...
    characteristics: `Seaborne are often: candid, cooperative, exuberant, fierce, resolute, weathered.`,
    features: [
      {
        name: 'Safe Harbor',
        description: `<p>Once per session, when you take a short or long rest, you may take one additional downtime action.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Scoundrel',
        description: `<p>You have advantage on any rolls where you’re negotiating with criminals, detecting lies, or finding a safe place to hide.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: `<p>When you are in an area with low light or heavy shadow, you have advantage on rolls to hide, investigate, or perceive details within that area.</p>`,
      },
    ],
  },
  {
    ...
    characteristics: `Wanderborne are often: magnanimous, mirthful, inscrutable, reliable, savvy, unorthodox.`,
    features: [
      {
        name: 'Nomadic Pack',
        description: `<p>Add a Nomadic Pack to your inventory. Once per session, you may spend a Hope to reach into this pack and pull out a common item that is useful in this situation. Work with the GM to figure out what this item is.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Lightfoot',
        description: `<p>Your movement is naturally silent. Take advantage on any action rolls you make to move without being heard. Spend a Hope to also grant this ability to an ally in very close range of you.</p>`,
      },
    ],
  },
];
