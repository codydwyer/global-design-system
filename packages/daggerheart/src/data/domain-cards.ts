...
const domainCards: IDomainCard[] = [
  {
    ...
    type: 'spell',
    effects: [
      `<p>At the beginning of a session, place a number of tokens equal to your Spellcast Trait on this card.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>You have a deeply personal token or trinket that can be infused with protective magic and held as a ward by you or an ally. Describe what it is and why it’s important to you. When the holder of the ward takes damage, they can spend Hope to reduce it by 1d8.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Spend a Hope to allow a creature you can touch to climb on walls and ceilings as easily as walking on the ground below. This spell will end after ten minutes or when you cast it on another creature.</p>`,
    ],
  },
  {
    id: 'cinder-grasp',
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against a target in melee range. On a success, the target instantly bursts into flames, dealing 1d20 magic damage and temporarily catching them on fire.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>You can spend a Hope to create a single, small floating orb that you can control anywhere within very far range from you. While controlling it, you can choose to see through its vision as though it’s your own. If the orb takes damage or moves out of range, the spell will immediately end.</p>
    `,
    ],
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against a spell or magical effect about to happen within far range. On a success, the GM will tell you how many Stress you can mark to end it.</p>
    `,
    ],
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Mark a Stress to take flight for a number of minutes equal to your level. While flying, you may spend a Hope to pick up and carry another creature approximately your size or smaller. You cannot carry more than one other creature at a time.</p>
    `,
    ],
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (12). On a success, spend a Hope and vanish, teleporting to another place you can see within very far range. If any creatures are very close to you when you succeed, you can spend an additional Hope each to bring them with you.</p>
    `,
    ],
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against all enemies within melee range of you. Any you succeed against are hurdled into far range. Roll an amount of d8s equal to your Spellcast Trait and also do that much magic damage to each of them.</p>`,
    ],
  },
  {
    id: 'chain-lightning',
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Once per long rest, you have the ability to instantly teleport yourself and a number of others within close range up to your Level somewhere you’re aware of. Choose one option below to gain additional modifiers, then make a Spellcast Roll (16):</p>
    <ul>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>When a majority of the domain cards in your loadout are from the Arcana domain:</p>
    <ul>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make an Attack Roll using your primary weapon against a target. On a success, along with dealing damage, you can also spend a Hope to immediately become hidden.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Whenever you would take magic damage, if you choose not to reduce it using Armor, you may spend a Hope to roll an amount of d6 equal to your Spellcast Trait. If any of the dice roll a result of 6, the attack is reflected back onto the caster, dealing the damage to them instead.</p>`,
    ],
  },
  {
    id: 'confusing-aura',
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (16). Once per short rest, on a success all creatures within very far range of your choice must make a Reaction Roll (18). On a failure, they take 3d10 physical damage and are Vulnerable. On a success, they take half damage (rounded up).</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>After a dice roll, you may spend 5 Hope to change the results of that roll to a result of your choice instead. The result must be plausible within the range of the dice.</p>`,
    ],
  },
  {
    id: 'falling-sky',
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against all enemies within far range. Mark any number of Stress to make shards of arcana rain down from above, dealing 1d20 damage per each Stress you marked to any targets you succeed against.</p>`,
    ],
  },
  {
    id: 'not-good-enough',
    ...
    type: 'ability',
    effects: [
      `<p>When you roll your damage dice, you may reroll any 1s or 2s. If you do, you must take the new result, even on a 1 or 2.</p>`,
    ],
  },
  {
    id: 'retaliation',
    ...
    type: 'ability',
    effects: [
      `<p>When you take damage from a creature in melee range, you may mark a Stress to immediately deal weapon damage to the creature at half Proficiency (rounded up).</p>`,
    ],
  },
  {
    id: 'whirlwind',
    ...
    type: 'ability',
    effects: [
      `<p>When you make a successful attack using a weapon with melee or very close range, you may also spend a Hope to use that roll against every other enemy in that weapon’s range. Any additional enemies you succeed against with this ability take half damage (rounded up).</p>`,
    ],
  },
  {
    id: `a-soldiers-bond`,
    ...
    type: 'ability',
    effects: [
      `<p>Once per long rest, if you compliment someone or ask them about something they are good at, you may both take 3 Hope.</p>`,
    ],
  },
  {
    id: `reckless`,
    ...
    recallCost: 1,
    type: 'ability',
    effects: [`<p>You may always mark a Stress to take advantage on an Attack Roll against a target.</p>`],
  },
  {
    id: `scramble`,
    name: `Scramble`,
    ...
    type: 'ability',
    effects: [
      `<p>Once per short rest, when an enemy in melee range would deal damage to you, you can avoid the damage entirely and safely move out of melee range of the enemy.</p>`,
    ],
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>You can choose to use the Character Trait of your choice on an equipped weapon, rather than the trait the weapon calls for.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Once per short rest, you can apply all your focus towards a single target. Choose that target. Until you attack another target, you defeat the creature, or the battle ends, add +1 to your Proficiency.</p>`,
    ],
  },
  {
    id: `fortified-armor`,
    ...
    type: 'ability',
    effects: [
      `<p>Increase your Armor total by +2 while this card is active in your loadout. Once per short rest, you may use an Armor Slot without marking it.</p>`,
    ],
  },
  {
    id: `deathtoll`,
    ...
    type: 'ability',
    effects: [
      `<p>When you take this card, permanently add one additional Stress Slot and one additional Hit Point Slot, then place it into your Vault permanently.</p>`,
    ],
  },
  {
    id: `heros-strike`,
    ...
    type: 'ability',
    effects: [
      `<p>When you land a critical hit on an Attack Roll, choose two of the following:
    </p>
    <ul>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Once per long rest, when you mark your final Hit Point, instead of making a death move, you can choose to automatically take a Scar (permanently cross out one Hope Slot), and roll 1d6. Clear that many Hit Points and stay on your feet.</p>`,
    ],
  },
  {
    id: `rage-up`,
    ...
    type: 'ability',
    effects: [
      `<p>Before making an Attack Roll, you may spend a Hope to temporarily increase your Proficiency by +1 until the end of the attack.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>When a majority of the domain cards in your loadout are from the Blade domain:</p>
    <ul>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Whenever you make an attack that misses its target, you may mark a Stress to still hit the target for weapon damage at half Proficiency (rounded up).</p>`,
    ],
  },
  {
    id: `battle-cry`,
    ...
    type: 'ability',
    effects: [
      `<p>Once per short rest, while you are charging into danger, you can muster a rousing shout or phrase that inspires your allies. You and all your allies that can hear you each clear a Stress, gain a Hope, and until you or an ally fails a roll with Fear, gain +1 Proficiency.</p>`,
    ],
  },
  {
    id: `frenzy`,
    ...
    type: 'ability',
    effects: [
      `<p>Once per long rest, you can go into a frenzied state until there are no more threats within sight.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Whenever you deal enough Weapon damage to defeat an enemy, you can gain a Hope or clear a Stress. When you roll a Critical Success on a weapon attack, you gain an additional Hope or clear an additional Stress.</p>`,
    ],
  },
  {
    id: `reaper-strike`,
    ...
    type: 'ability',
    effects: [
      `<p>You may declare you are using Reaper Strike. Spend a Hope and make an Attack Roll. The GM will tell you any enemy it would succeed against in range of your weapon. Once per long rest, choose one of these enemies, and immediately deal 5 Hit Points of damage to them.</p>`,
    ],
  },
  {
    id: `battle-monster`,
    ...
    type: 'ability',
    effects: [
      `<p>When you make a successful attack against an enemy, instead of rolling for damage you may spend 5 Hope to deal the target a number of Hit Points equal to the amount of Hit Points you currently have marked.</p>`,
    ],
  },
  {
    id: `onslaught`,
    ...
    type: 'ability',
    effects: [
      `<p>When you successfully hit, your weapon attacks never deal damage beneath a target’s Major Damage Threshold (you will always deal a minimum of 2 Hit Points of damage).</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>You can spend a Hope to move anywhere within far range without making an Agility Roll to get there.</p>`,
    ],
  },
  {
    id: `i-see-it-coming`,
    ...
    type: 'ability',
    effects: [
      `<p>When you are targeted by a ranged attack, mark a Stress to roll your Hope Die and increase your Evasion against this attack by its value.</p>`,
    ],
  },
  {
    id: `nimble`,
    ...
    recallCost: 1,
    type: 'ability',
    effects: [`<p>While this card is in your loadout, add your Agility score to your Evasion.</p>`],
  },
  {
    id: `ferocity`,
    name: `Ferocity`,
    ...
    type: 'ability',
    effects: [
      `<p>When you cause an enemy to mark any Hit Points, spend a Hope to temporarily increase your Evasion by the number of Hit Points you dealt. This bonus lasts until after the next attack that targets you.</p>`,
    ],
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>After a long rest, place a number of tokens equal to your Knowledge Trait on this card, with a minimum of 1. When you move into melee range of an enemy and make an Attack Roll against them, you may spend one token to choose an option below.</p>
    <ul>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>When you use an Armor Slot to reduce incoming damage, you may also spend any number of Hope. For every Hope you spend, reduce the incoming damage by the value of your Proficiency.</p>`,
    ],
  },
  {
    id: `tactician`,
    ...
    type: 'ability',
    effects: [
      `<p>When you Help an Ally, the advantage die you add is a 1d8. When making a Tag Team roll, you can roll a d20 for your Hope die.</p>`,
    ],
  },
  {
    id: `boost`,
    ...
    type: 'ability',
    effects: [
      `<p>If you have an ally in close range of you, mark a Stress to boost off of them and into the air to perform an aerial attack at an enemy within far range. You have advantage on the attack, add 1d10 to the damage, and end your action in melee range of the target.</p>`,
    ],
  },
  {
    id: `redirect`,
    ...
    type: 'ability',
    effects: [
      `<p>When you successfully evade a ranged attack, you may roll a number of d6s equal to your proficiency. If any roll a 6, mark a stress to redirect the attack to instead damage an enemy within very close range of you.</p>`,
    ],
  },
  {
    id: `know-thy-enemy`,
    ...
    type: 'ability',
    effects: [
      `<p>When observing a creature, you can make a Instinct Roll against the target. On a success, spend a Hope and ask the GM for two of the mechanical specifics about the target from below:</p>
    <ul>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>During a short rest, you can always choose to do one of the long rest options instead. You may spend a Hope to let one additional party member do the same.</p>`,
    ],
  },
  {
    id: `rapid-riposte`,
    ...
    type: 'ability',
    effects: [
      `<p>When you successfully evade an attack from melee range, you can mark a Stress to automatically deal damage from an active weapon to the attacker.</p>`,
    ],
  },
  {
    id: `bone-touched`,
    ...
    type: 'ability',
    effects: [
      `<p>When a majority of the domain cards in your loadout are from the Bone domain:</p>
    <ul>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Whenever you make a successful attack with a weapon, add either your Finesse or Agility trait to the damage.</p>`,
    ],
  },
  {
    id: `breaking-blow`,
    ...
    type: 'ability',
    effects: [
      `<p>When you make a successful attack, you may mark a Stress to make the next successful attack against that same target do an additional 2d12 damage.</p>`,
    ],
  },
  {
    id: `wrangle`,
    ...
    type: 'ability',
    effects: [
      `<p>Make an Agility Roll against all enemies close to you. You may spend a Hope to move any enemies you are successful against to any position within close range.</p>
  ...
  },
  {
    ...
    recallCost: 3,
    type: 'ability',
    effects: [`<p>When you have 2 or less Hit Points remaining, always add your proficiency to your Evasion.</p>`],
  },
  {
    id: `deathrun`,
    name: `Deathrun`,
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>After you successfully evade an attack, you may clear a Stress. If you successfully evade an attack and have no Stress to clear, instead gain a Hope.</p>`,
    ],
  },
  {
    id: 'book-of-ava',
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Choose a target creature within close range. You can temporarily banish them from this realm. Roll an amount of d20s equal to your Spellcast Trait and tell the GM the highest result. The GM must make a Reaction Roll with a target number of this result.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>When a majority of the domain cards in your loadout are from the Codex domain:</p>
      <p></p>
      <ul>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (14). On a success, once per long rest, the GM will tell you what enemies within far range have a difficulty of 14 or lower. You may mark a Stress for each one you wish to hit with this spell. They are immediately killed and cannot come back to life by any means.</p>`,
    ],
  },
  {
    id: `book-of-yarrow`,
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Once per long rest, spend 5 Hope to cast this spell on two or more willing creatures that wish to be bonded. Until your next short rest, any creatures that have this union with each other can always share Hit Points Slots and Stress Slots between them.</p>`,
    ],
  },
  {
    id: `deft-deceiver`,
    ...
    type: 'ability',
    effects: [
      `<p>Spend a Hope to take advantage on a roll you make to deceive or trick someone into believing a lie you tell them.</p>`,
    ],
  },
  {
    id: `enrapture`,
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against a close target.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>You can imbue your speech with enhancing power. You can mark a Stress when you recite your words and choose an option from the list below to grant to an ally who hears it:</p>
    <ul>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against a target within very close range. On a success, they can’t lie to you while they remain within close range, but they are not compelled to speak. If you ask them a question and they refuse to answer, they mark a stress and the spell ends.</p>`,
    ],
  },
  {
    id: `thought-delver`,
    ...
    type: 'spell',
    effects: [
      `<p>You can peek into the minds of others. Spend a Hope to read the vague surface thoughts of a target within far range. Make a Spellcast Roll against the target to delve for deeper, more hidden thoughts.</p>`,
    ],
  },
  {
    id: `hypnotic-shimmer`,
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (10) while touching a creature. On a success, mark a Stress and the target becomes hidden for 1 hour, until you cast this spell again, or until the target makes an Attack or Spellcast Roll.</p>`,
    ],
  },
  {
    id: `soothing-speech`,
    ...
    type: 'ability',
    effects: [
      `<p>During a short rest, when you use the Tend to Wounds downtime action on another character, you may speak supportive words to heal an extra Hit Point on them. When you do, also heal two of your own.</p>`,
    ],
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Point to a target within very far range. You can now see through their eyes and hear through their ears. You may return to this vision at any time until you cast another spell or mark a Hit Point.</p>`,
    ],
  },
  {
    id: `secret-plan`,
    ...
    type: 'ability',
    effects: [
      `<p>Once per long rest, you may explain how you’ve secretly had preparation in place for the kind of situation you’re in, and describe what it is. The GM will tell you how much Stress you need to mark for it.</p>
    <ul>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>When you whisper words of discord to an adversary in melee range, make a Spellcast Roll (13). On a success, the GM immediately makes an attack against another enemy instead of against you or your allies. If in combat, the GM spends a token from the action tracker to do so.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>When you mark one or more Hit Points from an attack, you may mark a Stress to place a number of tokens on this card equal to the number of Hit Points you marked. On your next attack, you may increase your Proficiency by +1 for each token on this card, then clear all tokens.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Whenever you make an Action Roll to persuade, lie, or garner favor, you can spend a Hope to reroll the Hope or Fear die and take the new result instead.</p>`,
    ],
  },
  {
    id: `grace-touched`,
    ...
    type: 'spell',
    effects: [
      `<p>When a majority of the domain cards in your loadout are from the Grace domain:</p>
    <ul>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Once per long rest, mark a Stress to create a projected copy of yourself that can appear anywhere you’ve been before.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against all enemies within far range. Any you succeed against temporarily keep their attention on you, narrowing their field of view and drowning out any sound but your own. You may also mark a Stress to deal Stress to all targets who are enraptured.</p>`,
    ],
  },
  {
    id: `copycat`,
    ...
    type: 'ability',
    effects: [
      `<p>Once per long rest, this card can mimic the features of any other active Domain card in another player’s loadout of Level 8 or lower. You must spend Hope equal to half the card’s level (rounded up), and this lasts until your next short rest.</p>`,
    ],
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Add +3 to any two of your Experiences, or +5 to any one of your Experiences. Then permanently put this card into your Vault.</p>`,
    ],
  },
  {
    id: `encore`,
    ...
    type: 'spell',
    effects: [
      `<p>When an ally within close distance of you deals damage to an enemy, you may make a Spellcast Roll against that same enemy. On a success, you immediately do the same amount of damage to them as your ally dealt. If your Spellcast Roll succeeds with Fear, place this card into your Vault afterward.</p>`,
    ],
  },
  {
    id: `notorious`,
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>You have advantage on any attempt to pick a non-magical lock, disarm a trap, or steal an item from a target (either through stealth or by force).</p>`,
    ],
  },
  {
    id: `rain-of-blades`,
    ...
    type: 'spell',
    effects: [
      `<p>Spend 2 Hope to conjure throwing blades that strike any enemies close to you. Make a Spellcast Roll and all targets that you succeed against take d10 magic damage.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>When you have a few minutes to prepare, you can mark a Stress to don the facade of any humanoid you can picture clearly in your mind. While disguised, all Presence rolls to avoid scrutiny have advantage. The spell will begin to fade after one hour.</p>`,
    ],
  },
  {
    id: `midnight-spirit`,
    ...
    type: 'spell',
    effects: [
      `<p>Spend a Hope to summon an arcane spirit the same size as yourself that can move or carry things you can see until your next short rest.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against all enemies within Very Close range. All it succeeds against have their shadows temporarily pinned where they are, making them restrained.</p>`,
    ],
  },
  {
    id: `chokehold`,
    ...
    type: 'ability',
    effects: [
      `<p>While hidden, when you successfully position yourself behind a creature that’s about your size, you can mark a Stress to pull them into a chokehold or equally compromising position and make them temporarily Vulnerable.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>When you attempt to move through a dangerous area without being noticed, if you roll with Fear, you can always mark a Stress to change it to a roll with Hope instead.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against a target within very close range. On a success, spend a Hope to conjure a dark glyph upon their body that exposes their weak points, temporarily reducing the target’s Difficulty number by 1 + your Knowledge trait.</p>`,
    ],
  },
  {
    id: `hush`,
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against a target within close range. On a success, spend a Hope to temporarily conjure suppressive magic around the target that encompasses everything within very close range of them and follows them as they move.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Spend a Hope to activate Phantom Retreat where you’re currently standing. You may spend another Hope at any time before your next short rest to disappear from where you are and reappear where you were standing when you activated Phantom Retreat. This will end the spell.</p>`,
    ],
  },
  {
    id: `dark-whispers`,
    ...
    recallCost: 0,
    type: 'spell',
    effects: [`<p>You can speak into the mind of any person you’ve ever seen or know the true name of.</p>`],
  },
  {
    id: `mass-disguise`,
    name: `Mass Disguise`,
    ...
    type: 'ability',
    effects: [
      `<p>When you have a few minutes of silence to focus, you can mark a Stress to change the appearance of every willing target close to you, lasting for one hour. The new form must share a general body structure and size, and can be somebody or something you’ve seen before or entirely fabricated.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>When a majority of the domain cards in your loadout are from the Midnight domain:</p>
    <ul>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>When you successfully evade physical damage, you can choose to envelope yourself in shadow, becoming Hidden and teleporting to anywhere in close range of the target that attacked you. You remain Hidden until the next time you make an action roll.</p>`,
    ],
  },
  {
    id: `rune-thief`,
    ...
    type: 'spell',
    effects: [
      `<p>When you should take magic damage, place tokens on this card equal to the number of hit points that damage would do. Then, reduce the incoming damage in half (rounded up).</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Under the cover of shadow, your prowess is enhanced. While you are shrouded in low light or darkness, you gain +1 Proficiency to your weapon attacks and you can add your Spellcast trait to your Evasion.</p>`,
    ],
  },
  {
    id: `night-terror`,
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (16). On a success, once per long rest, spend 3 Hope to plunge the entire area within far range into magical shadow that moves with you. Whenever you or an ally within this shadow should be damaged by an attack or spell, roll 1d6. On a result of 5+, the attack or spell misses.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Mark a Stress to move like a ghost. While in this form, you are visible but can float and pass through solid objects for a number of minutes equal to your Spellcast Trait. During this time, you are immune to physical damage.</p>`,
    ],
  },
  {
    id: `gifted-tracker`,
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll to track or ask the GM one question you’d be able to learn about a specific creature or group of creatures based on signs of their passage. If you spend Hope before the roll, you can double your spellcast trait as the modifier.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>You can speak the language of the hidden, natural world. When you want to speak to the plants and animals around you, make an Instinct Roll (12). On a success, they’ll give you the information they know. With Fear, their knowledge might be limited or come at a cost.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Make a Spellcast Roll against a target within far range. On a success, roots and vines reach out from the ground and temporarily Restrain them, dealing 1d8 physical damage.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against a creature within far range. On a success, mark a Stress, deal d6 magic damage to the target, and the target’s Difficulty value is temporarily reduced by 1.</p>`,
    ],
  },
  {
    id: `towering-stalk`,
    ...
    type: 'spell',
    effects: [
      `<p>You can conjure a thick, twisting stalk within close range that can be easily climbed. It’s height can grow up to far range.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Choose an option below and make a Spellcast Roll against the target. On a success, vines reach out from your hands, causing the chosen effect and making them restrained.</p>
    <ul>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Once per long rest, you can conjure a field of small, healing plants around you. Everywhere within close range of you bursts to life with vibrant nature, causing you and your allies in the area to immediately heal one Hit Point.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>As an additional downtime option, you may roll 1d6 to see what you forage. Work with the GM to describe it, and add it to your inventory as a Consumable. Your party may carry up to five foraged Consumables at a time.</p>
    <ol>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Once per long rest, mark a Stress to channel the natural world around you and use it to transform into something monstrous. Describe how your appearance changes, then place a d6 on this card at a value of 6.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>When a majority of the domain cards in your loadout are from the Sage domain:</p>
    <ul>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (13). On a success, spend any number of Hope to create an equal number of small Forest Sprites that appear wherever you choose within far range, distracting enemies and aiding allies. Describe what form they take.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>After a long rest, place a number of tokens equal to how many Sage Domain cards you have in your Loadout and Vault on this card.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (18). On a success, you reshape the natural world, changing the surrounding plant life within very far distance of you. You can grow trees instantly, clear a path through dense vines, create a wall of thick roots, etc.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>You can mark a Stress to transform into a hulking nature spirit, gaining the following benefits:</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Choose one of the following tempests and make a Spellcast Roll against all targets in far range. Any you are successful against experience its effects until the GM spends 3 Fear to end this spell:</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against a target within far range. On a success, spend a Hope to send a bolt of shimmering light towards them. Treat it like a ranged weapon, dealing d8 magic damage that makes them glow brightly and become temporarily Vulnerable.</p>`,
    ],
  },
  {
    id: `mending-touch`,
    ...
    type: 'spell',
    effects: [
      `<p>You lay your hands upon a creature and channel healing magic to help close their wounds. When you can take a few minutes to focus on the person you’re helping, spend 2 Hope and heal a Hit Point or a Stress.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Once per short rest, after an ally attempts an Action Roll, but before the consequences take place, you may offer assistance or words of support. When you do, they may reroll their dice. They must accept the result of this new roll.</p>`,
    ],
  },
  {
    id: `final-words`,
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (13). On a success, you can infuse a moment of life into a corpse in order to speak with it. If the result is with Hope, it will answer up to three questions. If the result is with Fear, only one. Once the spell ends or on a failure, the body will turn to dust.</p>`,
    ],
  },
  {
    id: `healing-hands`,
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (13) and target a creature other than yourself in melee. On a success, mark a Stress to heal the target 2 Hit Points or 2 Stress. On a failure, mark a Stress to heal the target 1 Hit Point or 1 Stress.</p>`,
    ],
  },
  {
    id: `conviction`,
    ...
    type: 'ability',
    effects: [
      `<p>You speak with an unmatched power and grace. When you attempt to use this candor to de-escalate a violent situation or get someone to follow your lead, roll with advantage.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Once per short rest, when you make a successful strike against an enemy, you may clear 3 Stress or one Hit Point. On a success with Hope, you may also clear 3 Stress or one Hit Point of an ally who is within close range of you.</p>`,
    ],
  },
  {
    id: `divination`,
    ...
    type: 'spell',
    effects: [
      `<p>Once per long rest, you may spend 3 Hope to reach out to the forces beyond and ask one question about an event, person, place, or situation in the near future. Your vision of the world will momentarily twist and shape around you to show the answer, though it may be cryptic, obscured, or partial.</p>`,
    ],
  },
  {
    id: `life-ward`,
    ...
    type: 'spell',
    effects: [
      `<p>Spend 3 Hope to point at a close ally and mark them with a glowing sigil of protection. If this ally is ever required to make a death move for any reason, they ignore it and clear one hit point.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Mark a Hope to adjust a section of natural material you are touching (like stone, ice, wood, etc) into a shape that suits your purpose. This material area can be no larger than you. Examples include forming a rudimentary tool or weapon, creating a door or passage, etc.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Spend 3 Hope to charge up a powerful smite. On the next successful attack, double your Proficiency on the damage roll, and this attack deals Magic damage, regardless of the weapon’s damage type.</p>`,
    ],
  },
  {
    id: `restoration`,
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Whenever you do damage to an enemy, you may spend a Hope to heal a single Hit Point on an ally within close range of you.</p>`,
    ],
  },
  {
    id: `splendor-touched`,
    ...
    type: 'ability',
    effects: [
      `<p>When a majority of the domain cards in your loadout are from the Splendor domain:</p>
    <ul>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Mark a Stress to cast Shield Aura on a creature you can touch. Whenever they use an Armor Slot, they roll a d12 and add its value to their Armor Score. If the d12 result is equal to or above their current level, this spell ends. If the d12 result is below their current level, it stays active.</p>`,
    ],
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll against any enemies in front of you within far distance as you unleash powerful rays of burning sunlight. Spend a Hope for each enemy you succeed against that you want to affect, and they must make a Reaction Roll (14).</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (15) to temporarily embody powerful presence. On a success, spend 2 Hope to make your Presence score equal to your Spellcast Trait until your next long rest.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (15). On a success, mark any amount of Stress to clear that many Hit Points on a line of allies within far range.</p>`,
    ],
  },
  {
    id: `invigoration`,
    ...
    type: 'spell',
    effects: [
      `<p>When you or an ally close to you has used an ability or spell that has an exhaustion limit (once per short rest, once per long rest, etc.), you and any of these allies may spend any amount of Hope to roll that many d6. On a 6, you or your ally regain use of that ability or spell.</p>
  ...
  },
  {
    ...
    type: 'spell',
    effects: [
      `<p>Make a Spellcast Roll (20). On a success, you may restore one creature who has been dead no longer than 100 years. Then roll a 1d6. On a 1-5, put this card into your Vault permanently.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>While this card is in your loadout, if you choose to not wear Armor, your Armor Score is equal to 3 + double your Strength Trait.</p>`,
    ],
  },
  {
    id: `forceful-push`,
    ...
    type: 'ability',
    effects: [
      `<p>When you make a successful melee attack, you can push the target out of melee range and spend Hope to make them temporarily Vulnerable.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>When an ally very close to you is going to take damage, you may mark a stress to stand in its way and take the damage instead. Reduce the damage by a value equal to your Strength Trait. You may also reduce the damage by spending armor slots.</p>`,
    ],
  },
  {
    id: `body-basher`,
    ...
    type: 'ability',
    effects: [
      `<p>You use the full force of your body in the fight. On a successful melee attack, always add your Strength Trait to your damage total.</p>`,
    ],
  },
  {
    id: `bold-presence`,
    ...
    type: 'ability',
    effects: [
      `<p>Whenever you make a Presence roll against a hostile target, you can also add your Strength trait to the roll.</p>`,
    ],
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>When you or an ally close to you rolls a critical success on an Attack Roll, whoever rolled the critical success may immediately clear a Hit Point or an additional Stress.</p>`,
    ],
  },
  {
    id: `lean-on-me`,
    ...
    type: 'ability',
    effects: [
      `<p>Once per long rest, when a character has failed at an action they were attempting, if you console or inspire them, you both clear 2 Stress.</p>`,
    ],
  },
  {
    id: `goad-them-on`,
    ...
    type: 'ability',
    effects: [
      `<p>Make a Presence roll against a target. On a success, the target takes a Stress and the next time they act, they target you with disadvantage.</p>`,
    ],
  },
  {
    id: `support-tank`,
    ...
    type: 'ability',
    effects: [
      `<p>When an ally close to you fails a roll, you may spend 2 Hope to allow them to reroll either their Hope or Fear die and take the new result instead.</p>`,
    ],
  },
  {
    id: `armorer`,
    ...
    type: 'ability',
    effects: [
      `<p>Your Armor Score increases by +1 while this ability is in your loadout.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Once per short rest, when you roll a Critical Success on an Attack Roll, you and all allies that can see or hear you may clear a Hit Point or 1d4 Stress.</p>`,
    ],
  },
  {
    id: `inevitable`,
    ...
    recallCost: 1,
    type: 'ability',
    effects: [`<p>Whenever you fail an Action Roll, your next Action Roll has Advantage.</p>`],
  },
  {
    id: `no-sweat`,
    name: `No Sweat`,
    ...
    type: 'ability',
    effects: [
      `<p>When you help an ally, are part of a Group Action Roll, or initiate a Tag Team Roll, roll 1d6. On a 4+, you gain a Hope.</p>`,
    ],
  },
  {
    id: `shrug-it-off`,
    ...
    type: 'ability',
    effects: [
      `<p>When you would take damage, you may mark a Stress to reduce the severity of the damage by one Threshold. When you do, roll 1d6. If the result is a 2 or below, place this card into your Vault.</p>`,
    ],
  },
  {
    id: `valor-touched`,
    ...
    type: 'ability',
    effects: [
      `<p>When a majority of the domain cards in your loadout are from the Valor domain:</p>
    <ul>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Once per long rest, mark 3 Stress to push your body to its limits, increasing all of your Character Traits by +2. This lasts until your next rest.</p>`,
    ],
  },
  {
    id: `ground-pound`,
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Spend a Hope to take a defensive stance that lasts until you move or fail a roll with Fear. While in this stance, note the area within close range of you. If any enemy ever occupies that area, they are immediately put into melee with you and are temporarily Restrained.</p>
  ...
  },
  {
    ...
    type: 'ability',
    effects: [
      `<p>Whenever you mark an Armor Slot, you can choose an ally who can see or hear you to gain a Hope or clear a Stress.</p>`,
    ],
  },
  {
    id: `unbreakable`,
    ...
    type: 'ability',
    effects: [
      `<p>When you mark your last Hit Point, instead of making a death move, you may roll a 1d6 and clear that many marked Hit Points. Then put this card into your Vault.</p>`,
    ],
  },
  {
    id: `unyielding-armor`,
    ...
    type: 'ability',
    effects: [
      `<p>Anytime you mark an Armor Slot, roll an amount of d6s equal to the Armor Slots you currently have marked. If any result in a 6, you don’t have to mark it.</p>`,
    ],
  },
];

export const getCardsByDomain = (domainId: string) => domainCards.filter((card) => card.domainId === domainId);

export const getDomainCardsByLevel = (domainIds: string[], level: number) => {
  return domainCards.filter((card) => card.level <= level && domainIds.includes(card.domainId));
};

export const getCardById = (cardId: string) => {
  const domainCard = domainCards.find((card) => card.id === cardId);
  const retCard = {
    ...domainCard,
    domain: getDomainById(domainCard!.domainId),
  };
  return retCard;
};

export const getCardsByIds = (cardIds: string[]) => cardIds.map((cardId) => getCardById(cardId));
