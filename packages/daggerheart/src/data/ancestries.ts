    ...
    features: [
      {
        ...
        description: `<p>Decide who you were created by and for what purpose. When you generate your Experiences at character creation, choose one that reflects this purpose and add +1 to it.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Fearless',
        description: `<p>When you roll with Fear, you may choose to mark a stress instead of the GM gaining Fear.</p>`,
      },
      {
        name: 'Dread Visage',
        description: `<p>You have advantage on rolls to intimidate other non-daemon creatures.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: `<p>When you should take physical damage, you may spend three Hope to only take half the damage instead.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: `<p>During a long rest, as one of your actions, you may choose to drop into a Celestial Trance. When you do, roll a number of d8 equal to the Stress you have marked, and clear all Stress. If any of these dice have a matching value, also clear all Hit Points.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Wings',
        description: `<p>Mark Stress to take flight until you next roll with Fear. While flying, your Evasion score increases by +2.</p>`,
      },
      {
        name: 'Luckbender',
        description: `<p>Once per session, after you or an ally in close range makes an Action Roll, you can mark a Stress to allow a reroll of the Duality Dice. If you do, take the new result.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Headbutt',
        description: `<p>Give the GM one Fear to headbutt an enemy you move into melee with. The target immediately takes d8 direct physical damage and can’t be targeted again by this attack during the fight.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Natural Calm',
        description: `<p>Whenever you should mark a Stress, roll 1d6. On a 6, you take no Stress.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: `<p>To speak with other Fungril across distance to access their hivemind of information, make an Instinct roll. At character creation, describe what ritual you must perform to tap into this connection.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: `<p>The shell on your back always protects you. Add your Proficiency to your armor score.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Endurance:',
        description: `<p>Gain an additional Hit Point Slot at character creation.</p>`,
      },
      {
        name: 'Reach',
        description: `<p>Any melee weapon you wield has its range increased to very close.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Danger Sense',
        description: `<p>Once per short rest, you may mark a stress to make the GM reroll an attack roll. If it still hits you, reduce the incoming value by your Proficiency.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Little Lucky',
        description: `<p>At the beginning of each session, give everyone in your party a Hope. You may always reroll a 1 on your Hope Die. If you do, take the new result instead.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Perseverance',
        description: `<p>When you fail a roll that utilized one of your Experiences, you may spend a Hope to reroll. You must take the new result.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description: `<p>On any Agility Rolls, you may mark a Stress to reroll your Hope Die. If you do, take the new result instead.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Sturdy',
        description: `<p>When you should mark an armor slot, roll a d6. On a 5+, you don’t mark the armor slot but still reduce the incoming damage by your armor score.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Amphibious',
        description: `<p>You can breathe and move underwater just as easily as on land.</p>`,
      },
      {
        name: 'Long Tongue',
        description: `<p>You can use your long, powerful tongue to grab onto things close to you. You may also mark Stress to unleash it as a Finesse Close weapon that does d12 physical damage.</p>`,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: 'Nimble',
        description: `<p>Take advantage on Agility Rolls that involve balancing and climbing ,and add +1 to your Evasion at character creation.</p>`,
      },
    ],
  },
];
